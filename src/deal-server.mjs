...
// pre-built public/ directory: index.html (the deal workspace, and the root
// route), the call pages under public/notes/, deal-index.json, deal-index.mjs,
// and the self-contained per-call exports under public/calls/ — those are
// generated by scripts/build-deal-index.mjs from src/export.js's tier1Html(),
// so that fallback view IS viewer.js, never a reimplementation.
//
