...
| Slice-2: email-from-verified-claims choke point (L8, spec-core: email role never sees transcript; uncited bullets cut; unknown claim_id rejects whole draft) | **projects-2f** | **in-progress** (claimed ~21:45) |
| Slice-2: README limitations block (follow-ups b+d: hyphen/slash false-rejection, taint-screen best-effort, cross-utterance cue gap) | **projects-2f** | **in-progress** (claimed ~21:45) |
